...
class HomeScreenViewModel : ViewModel() {
    ...
    private val dogBreedStateData : MutableState<DogsBreedModel> = mutableStateOf(DogsBreedModel("",listOf("")))
    ...
    fun getDogBreedStateData() : DogsBreedModel {
        return dogBreedStateData.value
    }
